...
func (s *testHotWriteRegionSchedulerSuite) TestRevertRegionsDimSecond(c *C) {
...
func (s *testHotWriteRegionSchedulerSuite) TestRevertRegionsDimFirst(c *C) {
...
func (s *testHotWriteRegionSchedulerSuite) TestRevertRegionsDimFirstOnly(c *C) {
...
func (s *testHotReadRegionSchedulerSuite) TestRevertRegionsDimSecond(c *C) {
	// This is a test that searchRevertRegions finds a solution of rank -2.
	ctx, cancel := context.WithCancel(context.Background())
	defer cancel()
	statistics.Denoising = false
