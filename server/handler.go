...
func (s *server) GetCoordinator() (*schedule.Coordinator, error) {
	return s.GetRaftCluster().GetCoordinator(), nil
}

func (s *server) GetCluster() (sche.SharedCluster, error) {
	return s.GetRaftCluster(), nil
}
